...
//        orang.minum();
        ...
        Manusia orang3 = new Manusia("Albert", 45);
        System.out.println("Nama = " + orang3.nama);
        System.out.println("Umur = " + orang3.umur + " tahun");
        ...
        System.out.println();
        Manusia orang4 = new Manusia("Gerrad");
        System.out.println("Nama = " + orang4.nama);
        System.out.println("Umur = " + orang4.umur + " umur");
        System.out.println("Tinggi = " + orang4.tinggiBadan + " cm");
        System.out.println("Berat Badan = " + orang4.beratBadan + " cm");
